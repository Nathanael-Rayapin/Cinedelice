...
<br />
<h3 className='title'>CinéDélices - Site de Recettes de Cuisine Inspirées par le Cinéma et la Télévision</h3><br />

<h2>1.Objet et Champ d'Application</h2><br />
<p>Les présentes Conditions Générales d'Utilisation (ci-après les « CGU ») ont pour objet de définir les modalités d’accès et d’utilisation du site CinéDélices (ci-après le « Site »), édité par ARCORATO, dont le siège social est situé 42 rue des bambis 75008 Paris.</p>

<p>Le Site propose un service de référencement, de consultation et, le cas échéant, de partage de recettes culinaires inspirées ou vues dans des œuvres cinématographiques et télévisuelles.</p>

<p>L'accès et l'utilisation du Site impliquent l'acceptation sans réserve des présentes CGU par l'Utilisateur.</p>
<br />

<h2>2. Accès et Inscription au Service</h2><br />
...
<p>La création d'un compte (ci-après le « Membre ») est nécessaire pour accéder à certaines fonctionnalités du Site (exemples : ajouter des recettes, commenter, liker des recettes).</p>

<p>Âge minimum requis : L'inscription en tant que Membre est strictement réservée aux personnes âgées de quinze (15) ans révolus ou plus.</p>

<p>Capacité juridique : L'Utilisateur garantit qu'il a la pleine capacité juridique d'accepter les présentes CGU.</p>

<p>Mineurs : Conformément à la législation française, l'Utilisateur âgé de 15 ans ou plus est présumé pouvoir procéder seul à l'acceptation des CGU dans le cadre de l'utilisation d'un service en ligne, sans préjudice du droit des titulaires de l'autorité parentale d'exercer un contrôle sur l'utilisation du Site par l'enfant. CinéDélices se réserve le droit de demander toute pièce justificative de l'âge de l'Utilisateur.</p>

<h4>2.3. Obligations de l'Utilisateur</h4>
<p>Le Membre est seul responsable de la confidentialité de son identifiant et de son mot de passe. Il s'engage à fournir des informations exactes lors de son inscription et à les maintenir à jour.</p>
<br />
<h2>3. Propriété Intellectuelle (Contenus du Site)</h2><br />
<h4>3.1. Contenus édités par le Site</h4>
<p>L'ensemble des contenus présents sur le Site (textes des recettes rédigés par l'Éditeur, logos, images des plats, structure, etc.) est protégé par le Code de la propriété intellectuelle.</p>

<p>Toute reproduction, représentation, modification, publication ou adaptation de tout ou partie des éléments du Site, quel que soit le moyen ou le procédé utilisé, est formellement interdite sans l'autorisation écrite préalable de CinéDélices.</p>

<h4>3.2. Références Cinématographiques</h4>
<p>Le Site opère des références aux films uniquement dans un but d'information et d'inspiration culinaire. CinéDélices ne prétend à aucun droit de propriété intellectuelle sur les films cités, les marques déposées, ou les personnages associés.</p>

<h4>3.3. Contenus des Membres</h4>
<p>Les Membres peuvent être autorisés à soumettre leurs propres recettes ou commentaires (ci-après les « Contributions »).</p>

<p>Le Membre cède à titre gratuit à CinéDélices le droit non exclusif d'utiliser, reproduire, représenter et adapter ses Contributions sur le Site et sur tout autre support de communication lié au Site.</p>

<p>Le Membre garantit qu'il est l'auteur des Contributions et qu'elles ne portent atteinte à aucun droit de tiers (droit d'auteur, droit à l'image, etc.).</p>
<br />
<h2>4. Obligations et Responsabilité de l'Utilisateur</h2><br />
...
<ul>
<li>Publier des propos ou Contenus à caractère illicite, diffamatoire, injurieux, haineux, raciste ou portant atteinte à la dignité humaine.</li>
</ul>

<p>Porter atteinte à l'ordre public et aux bonnes mœurs.</p>

<p>Tenter d’accéder de manière non autorisée au système informatique du Site ou de se livrer à toute activité perturbant le fonctionnement du Site.</p>

<p>Utiliser les recettes du Site à des fins commerciales sans autorisation préalable.</p>

<h4>4.2. Responsabilité</h4>
<p>L'Utilisateur est seul responsable des dommages de toute nature, matériels ou immatériels, causés à CinéDélices ou à des tiers, du fait de l'utilisation ou de l'exploitation illicite du Site.</p>
<br />
<h2>5. Responsabilité de l'Éditeur</h2><br />
<p>CinéDélices ne garantit pas la qualité, la fiabilité ou l'exactitude des recettes proposées.</p>

<p>Sécurité et Danger : L'Utilisateur reconnaît que l'exécution d'une recette de cuisine comporte des risques (coupe, brûlure, allergies, etc.). L'exécution des recettes se fait sous l'entière responsabilité de l'Utilisateur, qui doit prendre toutes les mesures de sécurité appropriées et vérifier la conformité des ingrédients avec ses propres besoins alimentaires.</p>

<p>Accessibilité : CinéDélices s'efforce d'assurer l'accès continu au Site, mais ne peut garantir que le Site sera exempt d'erreurs techniques ou d'interruptions.</p>
<br />
<h2>6. Protection des Données Personnelles (RGPD)</h2><br />
<p>CinéDélices s'engage à protéger les données personnelles de ses Utilisateurs.</p>
<br />
<h2>7. Droit Applicable et Litiges</h2><br />
<p>Les présentes CGU sont régies par le droit français.</p>

<p>En cas de litige entre CinéDélices et l'Utilisateur, une solution amiable sera recherchée en priorité. À défaut d'accord amiable, les tribunaux français seront seuls compétents.</p><br />
...
<br />
<h2>2. Les Données Collectées, Finalités et Bases Légales</h2><br />
...
<br />
<h2>3. Durée de Conservation des Données</h2><br />
...
<br />
<h2>5. Droits des Utilisateurs (Conformité RGPD)</h2><br />
